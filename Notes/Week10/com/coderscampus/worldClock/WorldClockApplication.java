package com.coderscampus.worldClock;
...
public class WorldClockApplication {
	...
	public static void main(String[] args) {
		...
		System.out.println("Albuquerque, NM, USA -> " + zonedDateTime.format(DateTimeFormatter.ofLocalizedDateTime(FormatStyle.MEDIUM)));
